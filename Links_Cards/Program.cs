...
namespace Links_Cards
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<CardsDbContext>(o => o.UseMySql(connectionStr, ServerVersion.AutoDetect(connectionStr)));

            builder.Services.AddAutoMapper(typeof(CardsMapper));
